...
data class CalendarUiState(
    ...
    fun getNumberSelectedDaysInWeek(
    ...
    fun monthOverlapSelectionDelay(
        ...
        return if (animateDirection?.isBackwards() == true) {
            val endWeek = currentWeekStartDate.plusDays(6)
            val isStartInADifferentMoth = endWeek.month != week.yearMonth.month
            if (isStartInADifferentMoth) {
